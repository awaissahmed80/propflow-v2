...
/**
 * Root tooltip. Prefer composition:
 *   <Tooltip><TooltipTrigger /><TooltipContent /></Tooltip>
 *
 * Shortcut (same theming):
    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-md px-3 py-1.5 text-xs text-balance",
            // Inverted surface via theme tokens — flips with .dark on <html>
