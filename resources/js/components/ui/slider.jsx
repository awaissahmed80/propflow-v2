    ...
    <SliderPrimitive.Root
      ...
      <SliderPrimitive.Control
        ...
        <SliderPrimitive.Track
          ...
          className="relative grow overflow-hidden rounded-full bg-primary/20 select-none data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5">
