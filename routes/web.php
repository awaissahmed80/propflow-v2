...
use App\Http\Controllers\Portal\BookingDocumentTypeController;
...
Route::middleware(['web', 'portal'])->group(function () use ($baseDomain) {
    ...
    Route::domain('portal.'.$baseDomain)->middleware(['auth', 'tenant'])->group(function () {
        ...
        Route::put('/leads/{lead}/shares', [LeadController::class, 'syncShares'])->name('portal.leads.shares');
        ...
        Route::post('/leads/{lead}/win', [LeadController::class, 'win'])->name('portal.leads.win');
        Route::post('/leads/{lead}/lose', [LeadController::class, 'lose'])->name('portal.leads.lose');
        ...
        Route::get('/bookings/{order}/panel', [OrderController::class, 'panel'])->name('portal.orders.panel');
        Route::get('/bookings/{order}/booking-form', [DealController::class, 'showBookingForm'])->name('portal.orders.show-booking-form');
        Route::get('/bookings/{order}/booking-form.pdf', [DealController::class, 'bookingFormPdf'])->name('portal.orders.booking-form.pdf');
        Route::post('/bookings/{order}/booking-form/email', [DealController::class, 'emailBookingForm'])->name('portal.orders.email-booking-form');
        ...
        Route::post('/settings/booking-documents', [BookingDocumentTypeController::class, 'store'])->name('portal.settings.booking-documents.store');
        Route::put('/settings/booking-documents/reorder', [BookingDocumentTypeController::class, 'reorder'])->name('portal.settings.booking-documents.reorder');
        Route::put('/settings/booking-documents/{documentType}', [BookingDocumentTypeController::class, 'update'])->name('portal.settings.booking-documents.update');
        Route::delete('/settings/booking-documents/{documentType}', [BookingDocumentTypeController::class, 'destroy'])->name('portal.settings.booking-documents.destroy');
