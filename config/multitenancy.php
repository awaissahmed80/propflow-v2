...
use App\Tenancy\FlushPermissionCacheTask;
use App\Tenancy\SessionTenantFinder;
...
return [
    /*
     * Session-based tenant resolution (no per-tenant subdomains).
     */
    ...
    'switch_tenant_tasks' => [
        ...
        FlushPermissionCacheTask::class,
    ],
